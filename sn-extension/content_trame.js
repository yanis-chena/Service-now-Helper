// content_trame.js
(async () => {
  console.log('🚀 SN Trame Tech démarré');
...
PMAD : OK / NOK
L'incident est rencontré sur : local / VDI 
Télétravail :  Oui / Non
 
Nombre de personne(s) impactée(s) : 
 
Date du dernier accès fonctionnel : 
Date et heure du dysfonctionnement : 
 
 
Contexte de l'erreur (actions réalisées par l'utilisateur / étapes) : 
...
Actions : `;
  ...
  showToast('✅ Trame Tech insérée avec succès.');
